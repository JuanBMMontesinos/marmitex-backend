...
var AppError, NotFoundError, BadRequestError;
...
var import_supabase_js, supabaseClient, supabase;
...
var MenuRepository;
var init_menu_repository = __esm({
  "src/modules/menu/menu.repository.ts"() {
    "use strict";
    init_supabase();
...
var SAO_PAULO_TZ, DAY_MAP, DAY_NAMES_PT;
var init_date = __esm({
  "src/shared/utils/date.ts"() {
    "use strict";
...
var MenuService;
var init_menu_service = __esm({
  "src/modules/menu/menu.service.ts"() {
    "use strict";
    init_menu_repository();
...
var import_zod3, menuItemDtoSchema, menuAddonDtoSchema, todayMenuResponseSchema, weeklyDayMenuSchema, weeklyMenuResponseSchema;
var init_menu_schema = __esm({
  "src/modules/menu/menu.schema.ts"() {
    "use strict";
    import_zod3 = require("zod");
    menuItemDtoSchema = import_zod3.z.object({
    ...
    menuAddonDtoSchema = import_zod3.z.object({
      id: import_zod3.z.string().uuid(),
      name: import_zod3.z.string(),
      price: import_zod3.z.number().nonnegative(),
      is_available: import_zod3.z.boolean(),
    ...
    todayMenuResponseSchema = import_zod3.z.object({
    ...
    weeklyDayMenuSchema = import_zod3.z.object({
      day_of_week: import_zod3.z.enum(["SEGUNDA", "TERCA", "QUARTA", "QUINTA", "SEXTA", "SABADO"]),
      day_name: import_zod3.z.string(),
      dishes: import_zod3.z.array(menuItemDtoSchema)
    });
    weeklyMenuResponseSchema = import_zod3.z.object({
...
var import_zod4, restaurantSettingsResponseSchema;
var init_settings_schema = __esm({
  "src/modules/settings/settings.schema.ts"() {
    "use strict";
    import_zod4 = require("zod");
    restaurantSettingsResponseSchema = import_zod4.z.object({
...
var init_delivery_zone_repository = __esm({
  "src/modules/delivery-zones/delivery-zone.repository.ts"() {
    "use strict";
    init_supabase();
...
var init_delivery_zone_service = __esm({
  "src/modules/delivery-zones/delivery-zone.service.ts"() {
    "use strict";
    init_delivery_zone_repository();
...
var DeliveryZoneController;
var init_delivery_zone_controller = __esm({
  "src/modules/delivery-zones/delivery-zone.controller.ts"() {
    "use strict";
    init_delivery_zone_service();
...
var import_zod5, deliveryZoneItemSchema, deliveryZonesResponseSchema;
var init_delivery_zone_schema = __esm({
  "src/modules/delivery-zones/delivery-zone.schema.ts"() {
    "use strict";
    import_zod5 = require("zod");
    deliveryZoneItemSchema = import_zod5.z.object({
    ...
    deliveryZonesResponseSchema = import_zod5.z.array(deliveryZoneItemSchema);
  }
});
...
var init_delivery_zone_routes = __esm({
  "src/modules/delivery-zones/delivery-zone.routes.ts"() {
    "use strict";
    init_delivery_zone_controller();
    init_delivery_zone_schema();
  }
});

// src/modules/orders/orders.repository.ts
var OrdersRepository;
var init_orders_repository = __esm({
  "src/modules/orders/orders.repository.ts"() {
    "use strict";
    init_supabase();
...
var init_payments_repository = __esm({
  "src/modules/payments/payments.repository.ts"() {
    "use strict";
    init_supabase();
...
var init_orders_service = __esm({
  "src/modules/orders/orders.service.ts"() {
    "use strict";
    init_orders_repository();
    init_menu_repository();
    init_delivery_zone_repository();
    init_settings_repository();
    init_payments_repository();
    init_app_error();
    init_pix();
    OrdersService = class {
...
var import_zod6, orderCustomerSchema, orderAddressSchema, orderItemInputSchema, createOrderInputSchema, updateOrderStatusInputSchema, orderDetailParamsSchema;
var init_orders_schema = __esm({
  "src/modules/orders/orders.schema.ts"() {
    "use strict";
    import_zod6 = require("zod");
    orderCustomerSchema = import_zod6.z.object({
    ...
    orderAddressSchema = import_zod6.z.object({
    ...
    orderItemInputSchema = import_zod6.z.object({
    ...
    createOrderInputSchema = import_zod6.z.object({
    ...
    updateOrderStatusInputSchema = import_zod6.z.object({
    ...
    orderDetailParamsSchema = import_zod6.z.object({
...
var init_payments_controller = __esm({
  "src/modules/payments/payments.controller.ts"() {
    "use strict";
...
var import_zod7, paymentWebhookSchema;
var init_payments_schema = __esm({
  "src/modules/payments/payments.schema.ts"() {
    "use strict";
    import_zod7 = require("zod");
    paymentWebhookSchema = import_zod7.z.object({
...
var import_fastify, import_cors, import_swagger, import_swagger_ui, import_fastify_type_provider_zod;
var init_app = __esm({
  "src/app.ts"() {
    "use strict";
    import_fastify = __toESM(require("fastify"));
    import_cors = __toESM(require("@fastify/cors"));
    import_swagger = __toESM(require("@fastify/swagger"));
    import_swagger_ui = __toESM(require("@fastify/swagger-ui"));
    import_fastify_type_provider_zod = require("fastify-type-provider-zod");
    init_env();
    init_error_handler();
    init_menu_routes();
    init_settings_routes();
    init_delivery_zone_routes();
    init_orders_routes();
...
async function getFastifyApp() {
  if (!appPromise) {
    appPromise = (async () => {
      const { buildApp: buildApp2 } = await Promise.resolve().then(() => (init_app(), app_exports));
      const app = buildApp2();
      await app.ready();
      return app;
    })();
...
async function handler(req, res) {
  try {
    ...
    console.error("\u274C ERRO CR\xCDTICO NA VERCEL:", err);
    res.statusCode = 500;
